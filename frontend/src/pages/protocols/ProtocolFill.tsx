                        ...
                        <div className="flex gap-2">
                          <button
                            className={`px-4 py-1.5 rounded-md font-bold text-sm transition-colors border ${
                              answers[item.id] === 'SI' ? 'bg-green-500 text-white border-green-600' : 'bg-white text-gray-600 border-gray-300 hover:bg-gray-100'
                            }`}
                          ...
                          <button
                            className={`px-4 py-1.5 rounded-md font-bold text-sm transition-colors border ${
                              answers[item.id] === 'NO' ? 'bg-red-500 text-white border-red-600' : 'bg-white text-gray-600 border-gray-300 hover:bg-gray-100'
                            }`}
                          ...
                          <button
                            className={`px-4 py-1.5 rounded-md font-bold text-sm transition-colors border ${
                              answers[item.id] === 'NA' ? 'bg-gray-500 text-white border-gray-600' : 'bg-white text-gray-600 border-gray-300 hover:bg-gray-100'
                            }`}
